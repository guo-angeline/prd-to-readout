# Analytics Blueprint: One-Tap Checkout

> Let returning customers place an order in a single tap, skipping the multi-screen flow.

_This is the plan we will measure against. If anything looks off, edit_ `analytics_blueprint.yaml` _(the machine-readable file next to this one) and re-run_ `prd-to-readout hypothesize`.
...
---
*Generated by prd-to-readout from your PRD. Source of truth: analytics_blueprint.yaml.*
